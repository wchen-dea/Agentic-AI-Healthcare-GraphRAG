...
DIAGNOSIS_TO_ICD10 = {
    ...
    "Allergy": "T78.40XA",
    "Drug Intolerance": "T88.7XXA",
    "Adverse Drug Reaction": "T88.6XXA",
}


def icd10_for(diagnosis: str) -> str:
    return DIAGNOSIS_TO_ICD10.get(diagnosis, "R69")
...
def ehr_event():
    ...
    payload = {
        ...
        "note": note,
        "system": system,
        "icd10_code": icd10_for(diagnosis),
    }
